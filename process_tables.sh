...
python rounding.py data/c128-model-coefs.csv out/model_coefs_c128_rounded.csv
python rounding.py data/c256-model-coefs.csv out/model_coefs_c256_rounded.csv
...
python rounding.py data/c128-model-coefs-grouped.csv out/model_coefs_grouped_c128_rounded.csv
python rounding.py data/c256-model-coefs-grouped.csv out/model_coefs_grouped_c256_rounded.csv
...
python rounding.py data/c128-results-table.csv out/results_table_c128_rounded.csv
python rounding.py data/c256-results-table.csv out/results_table_c256_rounded.csv
...
python rounding.py data/c128-cov-selection.csv out/cov_selection_c128_rounded.csv
python rounding.py data/c256-cov-selection.csv out/cov_selection_c256_rounded.csv
...
python rounding.py data/c128-cov-selection-grouped.csv out/cov_selection_grouped_c128_rounded.csv
python rounding.py data/c256-cov-selection-grouped.csv out/cov_selection_grouped_c256_rounded.csv
...
python tably.py out/model_coefs_grouped_c128_rounded.csv  -o out/model_coefs_grouped_c128_tex.txt  -r
python tably.py out/model_coefs_grouped_c256_rounded.csv  -o out/model_coefs_grouped_c256_tex.txt  -r
...
python tably.py out/results_table_c128_rounded.csv  -o out/results_table_c128_tex.txt  -r
python tably.py out/results_table_c256_rounded.csv  -o out/results_table_c256_tex.txt  -r
...
python tably.py out/cov_selection_grouped_c128_rounded.csv  -o out/cov_selection_grouped_c128_tex.txt  -r
python tably.py out/cov_selection_grouped_c256_rounded.csv  -o out/cov_selection_grouped_c256_tex.txt  -r
